...
if PDF_AVAILABLE:
    class PDFReport(FPDF):
        ...
        def footer(self):
            ...
            disclaimer = "Note: This valuation is an estimate based on recent transaction data and is for reference only."
    ...
    def generate_pdf_report(project_name, unit_info, valuation_data, analysis_data, history_df, comps_df, data_cutoff):
        ...
        pdf.ln(2)
        intro = f"I am writing to share a personalized market update for your unit at {project_name}. Based on recent transaction trends, here is an estimated valuation for your property."
        ...
        if ssd > 0:
            ...
            pdf.cell(40, 6, "Subject to SSD", new_x="LMARGIN", new_y="NEXT")
        else:
            pdf.set_text_color(39, 174, 96)
            pdf.cell(40, 6, "SSD Free", new_x="LMARGIN", new_y="NEXT")
        pdf.ln(5)
        ...
        if not history_df.empty:
            print_table(history_df, "Unit Transaction History") # History First
        
        print_table(comps_df.head(5), "Recent Comparable Transactions") # Comps Second
